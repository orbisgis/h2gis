...
" (2 3, 3 3, 3 2, 2 2, 2 3))'::GEOMETRY, "
    ...
    public void test_ST_LineCleaner1() throws Exception {
        ResultSet rs = st.executeQuery("SELECT ST_LineCleaner('LINESTRING (0 0 0, 10 0 0)'::GEOMETRY, 'LINESTRING (5 5 0, 5 -5 0)'::GEOMETRY);");
        rs.next();
    ...
    public void test_ST_LineCleaner2() throws Exception {
        ResultSet rs = st.executeQuery("SELECT ST_LineCleaner('LINESTRING (0 0 0, 10 0 0)'::GEOMETRY, "
