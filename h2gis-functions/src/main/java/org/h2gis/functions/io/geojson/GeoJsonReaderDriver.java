        ...
        if (hasGeometryField) {
            ...
            if(isH2) {
                if (finalGeometryTypes.size() == 1) {
                    ...
                    createTable.append("THE_GEOM " + finalGeometryType);
                } else {
                ...
                if (finalGeometryTypes.size() == 1) {
                    ...
                    finalGeometryType = "GEOMETRY" + (hasZ ? "Z" : "");
                    createTable.append("THE_GEOM GEOMETRY("+finalGeometryType+",").append(parsedSRID).append(")");
                }
            }
