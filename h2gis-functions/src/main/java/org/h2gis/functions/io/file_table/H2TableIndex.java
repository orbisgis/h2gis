...
public class H2TableIndex extends Index {
    ...
    @Override
    public double getCost(SessionLocal session, int[] masks, TableFilter[] tableFilters, int filter, SortOrder sortOrder, AllColumnsForPlan allColumnsForPlan, boolean isSelectCommand) {
        ...
        try {
            return 10 * getCostRangeIndex(masks, driver.getRowCount(),
                    tableFilters, filter, sortOrder, true, allColumnsForPlan, isSelectCommand);
