...
/**
 * Compute the  radius of the largest circle that is contained within a (multi)polygon.
 * @author Erwan Bocher, CNRS
 */
public class ST_MaximumInscribedCircleRadius extends DeterministicScalarFunction {

    public ST_MaximumInscribedCircleRadius() {
        addProperty(PROP_REMARKS, "Compute the radius of largest circle that is contained within a (multi)polygon or " +
