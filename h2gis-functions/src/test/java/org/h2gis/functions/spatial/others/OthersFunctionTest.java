...
public class OthersFunctionTest {
    ...
    public void testST_Clip7() throws Exception {
        ...
        String geomForClip ="MULTILINESTRING ((103.2 260.5, 110 257), \n" +
                "  (106 242, 115.3 252.5), \n" +
                "  (120 250, 140 250))";
        String resultGeom = "MULTILINESTRING ((108.37901726427623 257.8343293492696, 107 249, 111.41747572815534 248.11650485436894), (108.37901726427623 257.8343293492696, 110.2 269.5), (111.41747572815534 248.11650485436894, 117 247), (117 264, 129 254), (120 250, 134 250))";
        ResultSet rs = st.executeQuery("SELECT ST_CLIP('" +geomToClip+
                "'::GEOMETRY, '" + geomForClip+
                "'::GEOMETRY);");
        assertTrue(rs.next());
    ...
    public void testST_Clip8() throws Exception {
        ...
        String resultGeom = "MULTILINESTRING ((108.37901726427623 257.8343293492696, 107 249, 111.41747572815534 248.11650485436894), (108.37901726427623 257.8343293492696, 109.34146341463415 264), (109.34146341463415 264, 109.87219512195122 267.4), (109.87219512195122 267.4, 110.2 269.5), (111.41747572815534 248.11650485436894, 117 247), (117 264, 129 254), (120 250, 134 250))";
        ResultSet rs = st.executeQuery("SELECT ST_CLIP('" +geomToClip+
                "'::GEOMETRY, '" + geomForClip+
                "'::GEOMETRY);");
        assertTrue(rs.next());
    ...
    @Test
    public void testST_Clip12() throws SQLException {
        String geomToClip = "LINESTRING (60 250, 60 280, 80 250, 80 280, 100 250, 100 270, 141 270)";
        String geomForClip ="GEOMETRYCOLLECTION (POLYGON ((51 263, 123.33333333333333 263, 123.33333333333333 258.44444444444446, 51 258.44444444444446, 51 263)), \n" +
                "  LINESTRING (110 270, 130 270), \n" +
                "  LINESTRING (55 279, 95 279, 53 270))";
        String resultGeom = "MULTILINESTRING ((110 270, 130 270), (60 250, 60 258.44444444444446), (60 258.44444444444446, 60 263), (60 263, 60 271.5), (60 271.5, 60 279), (60 279, 60 280, 60.666666666666664 279), (60.666666666666664 279, 64.95833333333333 272.5625), (64.95833333333333 272.5625, 71.33333333333333 263), (71.33333333333333 263, 74.37037037037037 258.44444444444446), (74.37037037037037 258.44444444444446, 80 250, 80 258.44444444444446), (80 258.44444444444446, 80 263), (80 263, 80 275.7857142857143), (80 275.7857142857143, 80 279), (80 279, 80 280, 80.66666666666667 279), (80.66666666666667 279, 82.45833333333333 276.3125), (82.45833333333333 276.3125, 91.33333333333333 263), (91.33333333333333 263, 94.37037037037037 258.44444444444446), (94.37037037037037 258.44444444444446, 100 250, 100 258.44444444444446), (100 258.44444444444446, 100 263), (100 263, 100 270, 110 270), (130 270, 141 270))";
        ResultSet rs = st.executeQuery("SELECT ST_CLIP('" +geomToClip+
                "'::GEOMETRY, '" + geomForClip+
                "'::GEOMETRY);");
        assertTrue(rs.next());
