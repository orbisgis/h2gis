...
public class ProcessingFunctionTest {
    ...
    public void testLineMerger() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineMerge('MULTILINESTRING((0 0, 10 15), (56 50, 10 15))');")) {
            assertTrue(rs.next());
    ...
    public void testLineMerger2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineMerge('MULTILINESTRING((10 20, 10 10), (20 20,10 10)," +
    ...
    public void testLineMerger3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineMerge('MULTILINESTRING((20 10,20 20))');")) {
            assertTrue(rs.next());
    ...
    public void testLineMerger4() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineMerge('LINESTRING(20 10,20 20)');")) {
            assertTrue(rs.next());
            assertGeometryEquals("MULTILINESTRING ((20 10, 20 20))", rs.getBytes(1));
        }
    }
    ...
    public void testLineMerger5() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineMerge('POINT(20 20)');")) {
            assertTrue(rs.next());
    ...
    public void testLineMerger6() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineMerge('POLYGON((20 20, 40 20, 40 40, 20 40, 20 20))');")) {
            assertTrue(rs.next());
            assertGeometryEquals("MULTILINESTRING EMPTY", rs.getBytes(1));
        }
    }
    ...
    public void test_ST_LineIntersector1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineIntersector('LINESTRING (0 0 0, 10 0 0)'::GEOMETRY, 'LINESTRING (5 5 0, 5 -5 0)'::GEOMETRY);")) {
            rs.next();
    ...
    public void test_ST_LineIntersector2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineIntersector('LINESTRING (0 0 0, 10 0 0)'::GEOMETRY, "
    ...
    public void test_ST_LineIntersector5() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineIntersector('LINESTRING (452437 6838440, 452577 6837738, 452888 6837917)'::GEOMETRY, "
    ...
    public void test_ST_LineIntersector6() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_LineIntersector('LINESTRING ( 267 299, 293.9773755656108 139.93665158371041, 362 243 )'::GEOMETRY, "
    ...
    public void test_ST_OffSetCurve1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('POINT (10 10)'::GEOMETRY, 10);")) {
            rs.next();
    ...
    public void test_ST_OffSetCurve2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('LINESTRING (0 10, 10 10)'::GEOMETRY, 10);")) {
            rs.next();
    ...
    public void test_ST_OffSetCurve4() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('MULTILINESTRING ((0 10, 10 10),(10 20, 20 20))'::GEOMETRY, -10);")) {
            rs.next();
    ...
    public void test_ST_OffSetCurve5() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('POLYGON ((5 10, 10 10, 10 5, 5 5, 5 10))'::GEOMETRY, 10);")) {
            rs.next();
    ...
    public void test_ST_OffSetCurve6() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('POLYGON ((0 15, 15 15, 15 0, 0 0, 0 15), (5 10, 10 10, 10 5, 5 5, 5 10))'::GEOMETRY, 1);")) {
            rs.next();
    ...
    public void test_ST_OffSetCurve7() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('POLYGON ((0 15, 15 15, 15 0, 0 0, 0 15), (5 10, 10 10, 10 5, 5 5, 5 10))'::GEOMETRY, 10);")) {
            rs.next();
    ...
    public void test_ST_OffSetCurve8() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_OffSetCurve('GEOMETRYCOLLECTION (POLYGON ((0 15, 15 15, 15 0, 0 0, 0 15), (5 10, 10 10, 10 5, 5 5, 5 10)),LINESTRING (0 20, 10 20))'::GEOMETRY, 10);")) {
            rs.next();
    ...
    public void test_ST_Polygonize1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Polygonize('MULTILINESTRING ((130 190, 80 370, 290 380), \n"
    ...
    public void test_ST_Polygonize2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Polygonize('MULTILINESTRING ((50 240, 62 250, 199 425, 250 240), \n"
    ...
    public void test_ST_Polygonize3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Polygonize(st_union('MULTILINESTRING ((50 240, 62 250, 199 425, 250 240), \n"
                + " (50 340, 170 250, 300 370))'::GEOMETRY));")) {
            rs.next();
    ...
    public void test_ST_PrecisionReducer1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_PrecisionReducer('MULTIPOINT( (190 300 100), (10 11 50))'::GEOMETRY, 0.1);")) {
            rs.next();
    ...
    public void test_ST_PrecisionReducer2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_PrecisionReducer('MULTIPOINT( (190.005 300 100), (10.534 11 50))'::GEOMETRY, 1);")) {
            rs.next();
    ...
    public void test_ST_PrecisionReducer3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_PrecisionReducer('MULTIPOINT( (190.005 300 100), (10.534 11 50))'::GEOMETRY, 4);")) {
            rs.next();
    ...
    public void test_ST_RingSideBuffer1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_RingSideBuffer('LINESTRING (-10 10, 10 10)'::GEOMETRY, 10, 3);")) {
            assertTrue(rs.next());
    ...
    public void test_ST_RingSideBuffer3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_RingSideBuffer('POLYGON ((10 20, 20 20, 20 10, 10 10, 10 20))'::GEOMETRY, -1, 3);")) {
            assertTrue(rs.next());
    ...
    public void test_ST_RingSideBuffer6() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_RingSideBuffer('POLYGON ((10 20, 20 20, 20 10, 10 10, 10 20),"
    ...
    public void test_ST_SideBuffer1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SideBuffer('LINESTRING (120 150, 180 270)', 10);")) {
            rs.next();
    ...
    public void test_ST_SideBuffer4() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SideBuffer('LINESTRING (100 200, 150 250, 200 200)', 10, 'join=round quad_segs=2');")) {
            rs.next();
    ...
    public void test_ST_SideBuffer5() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SideBuffer('POINT (100 200)', 10, 'join=round quad_segs=2');")) {
            rs.next();
    ...
    public void test_ST_SideBuffer6() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SideBuffer(null, 10);")) {
            rs.next();
            assertNull(rs.getObject(1));
        }
    }
    ...
    public void test_ST_Simplify1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Simplify('MULTIPOINT( (190 300), (10 11 50))'::GEOMETRY, 4);")) {
            rs.next();
    ...
    public void test_ST_Simplify2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Simplify('LINESTRING (250 250, 280 290, 300 230, 340 300, 360 260, 440 310, 470 360, 604 286)'::GEOMETRY, 40);")) {
            rs.next();
    ...
    public void test_ST_Simplify3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Simplify('POLYGON ((250 250, 248 240, 250 180, 290 150, 332 165, 350 190, 330 200, 340 220, 360 260, 360 300, 330 310, 319 310, 300 310, 280 280, 256 284, 250 250))'::GEOMETRY, 40);")) {
            rs.next();
    ...
    public void test_ST_SimplifyPreserveTopology1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SimplifyPreserveTopology('MULTIPOINT( (190 300), (10 11 50))'::GEOMETRY, 4);")) {
            rs.next();
            assertTrue(((Geometry) rs.getObject(1)).equals(WKT_READER.read("MULTIPOINT( (190 300), (10 11 50))")));
        }
    }
    ...
    public void test_ST_SimplifyPreserveTopology2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SimplifyPreserveTopology('LINESTRING (250 250, 280 290, 300 230, 340 300, 360 260, 440 310, 470 360, 604 286)'::GEOMETRY, 40);")) {
            rs.next();
            assertTrue(((Geometry) rs.getObject(1)).equals(WKT_READER.read("LINESTRING (250 250, 280 290, 300 230, 470 360, 604 286)")));
        }
    }
    ...
    public void test_ST_SimplifyPreserveTopology3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_SimplifyPreserveTopology('POLYGON ((250 250, 248 240, 250 180, 290 150, 332 165, 350 190, 330 200, 340 220, 360 260, 360 300, 330 310, 319 310, 300 310, 280 280, 256 284, 250 250))'::GEOMETRY, 40);")) {
            rs.next();
            assertTrue(((Geometry) rs.getObject(1)).equals(WKT_READER.read("POLYGON ((250 250, 360 300, 332 165, 250 180, 250 250))")));
        }
    }
    ...
    public void test_ST_Snap1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Snap('LINESTRING(1 2, 2 4, 4 4, 5 2)'::GEOMETRY, "
    ...
    public void test_ST_Snap3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Snap('POLYGON((3 3, 1 2, 0 2, 0 1, -2 1, -1 7, 3 6, 4 8,7 8, 6 6, 9 6, 8 1, 8 1, 3 3))'::GEOMETRY,"
    ...
    public void test_ST_Split1() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('LINESTRING(0 8, 1 8 , 3 8, 8 8, 10 8, 20 8, 25 8, 30 8, 50 8, 100 8)'::GEOMETRY, 'POINT(1.5 4 )'::GEOMETRY, 4);")) {
            rs.next();
    ...
    public void test_ST_Split2() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('LINESTRING(0 0, 100 0)'::GEOMETRY, 'LINESTRING(50 -50, 50 50)'::GEOMETRY);")) {
            rs.next();
            Geometry geom = (Geometry) rs.getObject(1);
            assertTrue(geom.getNumGeometries() == 2);
    ...
    public void test_ST_Split3() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('LINESTRING(50 0, 100 0)'::GEOMETRY, 'LINESTRING(50 50, 100 50)'::GEOMETRY);")) {
            rs.next();
            Geometry geom = (Geometry) rs.getObject(1);
    ...
    public void test_ST_Split4() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('POLYGON (( 0 0, 10 0, 10 10 , 0 10, 0 0))'::GEOMETRY, 'LINESTRING (5 0, 5 10)'::GEOMETRY);")) {
            rs.next();
            Geometry geom = (Geometry) rs.getObject(1);
            assertTrue(geom.getNumGeometries() == 2);
    ...
    public void test_ST_Split5() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('POLYGON (( 0 0, 10 0, 10 10 , 0 10, 0 0))'::GEOMETRY, 'LINESTRING (5 1, 5 8)'::GEOMETRY);")) {
            rs.next();
            assertNull(rs.getObject(1));
        }
    }
    ...
    public void test_ST_Split6() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('POLYGON (( 0 0, 10 0, 10 10 , 0 10, 0 0))'::GEOMETRY, 'LINESTRING (5 1, 5 12)'::GEOMETRY);")) {
            rs.next();
            assertNull(rs.getObject(1));
        }
    }
    ...
    public void test_ST_Split7() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('POLYGON (( 0 0, 10 0, 10 10 , 0 10, 0 0), (2 2, 7 2, 7 7, 2 7, 2 2))'::GEOMETRY, 'LINESTRING (5 0, 5 10)'::GEOMETRY);")) {
            rs.next();
    ...
    public void test_ST_Split8() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('POLYGON (( 0 0 1, 10 0 5, 10 10 8 , 0 10 12, 0 0 12))'::GEOMETRY, 'LINESTRING (5 0, 5 10)'::GEOMETRY);")) {
            rs.next();
            Geometry pols = (Geometry) rs.getObject(1);
            for (int i = 0; i < pols.getNumGeometries(); i++) {
                Geometry pol = pols.getGeometryN(i);
    ...
    public void test_ST_Split9() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('MULTIPOLYGON ((( 0 0 1, 10 0 5, 10 10 8 , 0 10 12, 0 0 12)))'::GEOMETRY, 'LINESTRING (5 0, 5 10)'::GEOMETRY);")) {
            rs.next();
            Geometry pols = (Geometry) rs.getObject(1);
            for (int i = 0; i < pols.getNumGeometries(); i++) {
                Geometry pol = pols.getGeometryN(i);
    ...
    public void test_ST_Split10() throws Exception {
        try (ResultSet rs = st.executeQuery("SELECT ST_Split('MULTIPOLYGON (((50 200, 150 200, 150 100, 50 100, 50 200)),"
