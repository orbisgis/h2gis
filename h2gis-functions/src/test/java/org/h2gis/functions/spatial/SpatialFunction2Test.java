...
public class SpatialFunction2Test {
    ...
    public void test_ST_GENERATEPOINTS3() throws Exception {
        Statement st = connection.createStatement();
        ResultSet rs = st.executeQuery("SELECT ST_GeneratePoints('POLYGON ((300 300, 299 95, 600 100, 600 300, 450 180, 300 300))'::GEOMETRY,10, 15) as result");
        assertTrue(rs.next());
    ...
    @Test
    public void test_ST_GENERATEPOINTS4() throws Exception {
        Statement st = connection.createStatement();
        ResultSet rs = st.executeQuery("SELECT ST_GeneratePoints('POLYGON ((300 300, 299 95, 600 100, 600 300, 450 180, 300 300))'::GEOMETRY,10, 15, true) as result");
        assertTrue(rs.next());
    ...
    @Test
    public void test_ST_GENERATEPOINTS5() throws Exception {
        Statement st = connection.createStatement();
        ResultSet rs = st.executeQuery("SELECT ST_GeneratePoints('POLYGON ((300 300, 299 95, 600 100, 600 300, 450 180, 300 300), (330 200, 409 200, 409 125, 330 125, 330 200), (516 194, 575 194, 575 131, 516 131, 516 194))'::GEOMETRY,10, 15, true) as result");
        assertTrue(rs.next());
    ...
    @Test
    public void test_ST_GENERATEPOINTS6() throws Exception {
        Statement st = connection.createStatement();
        ResultSet rs = st.executeQuery("SELECT ST_GeneratePoints('POLYGON ((300 300, 299 95, 600 100, 600 300, 450 180, 300 300), (330 200, 409 200, 409 125, 330 125, 330 200), (516 194, 575 194, 575 131, 516 131, 516 194))'::GEOMETRY,10, 15, true, 2) as result");
        assertTrue(rs.next());
        assertEquals(2, ((Geometry)rs.getObject(1)).getNumGeometries());
    }
}
