...
public class OGCSpatialFunctionTest {
    ...
    public void test_ST_Buffer4() throws SQLException {
        ...
        try {
            assertTrue(rs.next());
            assertEquals("POLYGON ((183.81966011250105 260, 141.05572809000085 345.5278640450004, 140.51316701949486 353.1622776601684, 145.52786404500043 358.94427190999915, 153.16227766016837 359.48683298050514, 158.94427190999915 354.4721359549996, 208.94427190999915 254.47213595499957, 200 240, 100 240, 92.92893218813452 242.92893218813452, 90 250, 92.92893218813452 257.0710678118655, 100 260, 183.81966011250105 260))", rs.getString(1));
        } finally {
            rs.close();
        }
    }
