...
public class CreateFunctionTest {
    ...
    public void testST_MakeGridFromGeometryWithAngle3() throws Exception {
        ...
        rs.next();
        assertGeometryEquals("POLYGON ((-1.1213203435599524 1.1213203435542296, -0.41421356237520923 1.8284271247425814, 0.2928932188131428 1.1213203435578383, -0.41421356237160034 0.41421356236948625, -1.1213203435599524 1.1213203435542296))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON((-0.41421356237520923 1.8284271247425814, 0.2928932188095341 2.535533905930934, 0.9999999999978861 1.82842712474619, 0.2928932188131428 1.1213203435578383, -0.41421356237520923 1.8284271247425814))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON((0.2928932188095341 2.535533905930934, 0.9999999999942775 3.2426406871192857, 1.7071067811826295 2.5355339059345425, 0.9999999999978861 1.82842712474619, 0.2928932188095341 2.535533905930934))", rs.getObject(1));
        rs.close();
        st.execute("DROP TABLE gridAngle;");
    }
    ...
    public void testST_MakeGridFromGeometryWithAngle4() throws Exception {
        ...
        rs.next();
        assertGeometryEquals("POLYGON ((-1.1019588324945317E-5 2.9999926535695547, 0.9999889804049287 2.999996326774658, 0.9999926536100321 1.9999963267814043, -7.346383221307207E-6 1.9999926535763008, -1.1019588324945317E-5 2.9999926535695547))", rs.getObject(1));
        rs.next();
        ...
        rs.next();
        assertGeometryEquals("POLYGON ((0.9999889804049287 2.999996326774658, 1.9999889803981823 2.9999999999797615, 1.9999926536032857 1.9999999999865077, 0.9999926536100321 1.9999963267814043, 0.9999889804049287 2.999996326774658))", rs.getObject(1));
        rs.next();
        ...
        rs.next();
        assertGeometryEquals("POLYGON ((1.9999889803981823 2.9999999999797615, 2.999988980391436 3.0000036731848647, 2.9999926535965393 2.000003673191611, 1.9999926536032857 1.9999999999865077, 1.9999889803981823 2.9999999999797615))", rs.getObject(1));
        rs.close();
        st.execute("DROP TABLE gridAngle;");
    }
    ...
    public void testST_MakeGridFromGeometryWithAngle5() throws Exception {
        ...
        rs.next();
        assertGeometryEquals("POLYGON ((-1 0.9999999999948965, -2.5517365997984598E-12 1.999999999997448, 2.0000000000025517 2.5514590440423035E-12, 1.0000000000051035 -1.0000000000000002, -1 0.9999999999948965))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((-2.5517365997984598E-12 1.999999999997448, 0.9999999999948967 3, 3 1.0000000000051033, 2.0000000000025517 2.5514590440423035E-12, -2.5517365997984598E-12 1.999999999997448))", rs.getObject(1));
        rs.next();
        rs.close();
        st.execute("DROP TABLE gridAngle;");
    }
    ...
    public void testST_MakeGridFromGeometryWithAngleNegative() throws Exception {
        ...
        rs = st.executeQuery("select * from gridAngle order by id;");
        rs.next();
        assertGeometryEquals("POLYGON ((-1.0000000000000002 1.0000000000051035, -0.29289321881164837 1.7071067811898466, 0.4142135623730949 1.0000000000014948, -0.29289321881525704 0.29289321881675145, -1.0000000000000002 1.0000000000051035))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((-0.29289321881525704 0.29289321881675145, 0.4142135623730949 1.0000000000014948, 1.1213203435578383 0.2928932188131428, 0.41421356236948625 -0.41421356237160034, -0.29289321881525704 0.29289321881675145))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((0.41421356236948625 -0.41421356237160034, 1.1213203435578383 0.2928932188131428, 1.8284271247425814 -0.41421356237520923, 1.1213203435542296 -1.1213203435599524, 0.41421356236948625 -0.41421356237160034))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((-0.29289321881164837 1.7071067811898466, 0.4142135623767036 2.4142135623745897, 1.1213203435614467 1.707106781186238, 0.4142135623730949 1.0000000000014948, -0.29289321881164837 1.7071067811898466))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((0.4142135623730949 1.0000000000014948, 1.1213203435614467 1.707106781186238, 1.82842712474619 0.9999999999978861, 1.1213203435578383 0.2928932188131428, 0.4142135623730949 1.0000000000014948))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((1.1213203435578383 0.2928932188131428, 1.82842712474619 0.9999999999978861, 2.535533905930934 0.2928932188095341, 1.8284271247425814 -0.41421356237520923, 1.1213203435578383 0.2928932188131428))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((0.4142135623767036 2.4142135623745897, 1.1213203435650556 3.1213203435593333, 1.8284271247497987 2.4142135623709815, 1.1213203435614467 1.707106781186238, 0.4142135623767036 2.4142135623745897))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((1.1213203435614467 1.707106781186238, 1.8284271247497987 2.4142135623709815, 2.5355339059345425 1.7071067811826295, 1.82842712474619 0.9999999999978861, 1.1213203435614467 1.707106781186238))", rs.getObject(1));
        rs.next();
        assertGeometryEquals("POLYGON ((1.82842712474619 0.9999999999978861, 2.5355339059345425 1.7071067811826295, 3.2426406871192857 0.9999999999942775, 2.535533905930934 0.2928932188095341, 1.82842712474619 0.9999999999978861))", rs.getObject(1));
        rs.close();
        st.execute("DROP TABLE gridAngle;");
    }
