...
public class ST_GraphAnalysisTest {
    ...
    public static void setUp() throws Exception {
        ...
        connection = H2GISSimpleDBFactory.createSpatialDataBase("ST_GraphAnalysisTest", true);
        H2GISFunctions.registerFunction(connection.createStatement(), new ST_GraphAnalysis(), "");
