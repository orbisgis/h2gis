 ...
 * It will be call each time a <rte> markup is found.
 * It is for the 1.1 version
 * @author Antonin
 */
public final class GpxParserRte extends AbstractGpxParserRte {
         ...
         * It has in memory the default parser, the contentBuffer, the elementNames, the currentLine and the rteID.
         * @param reader
         *      The XMLReader used in the default class
         * @param parent
         *      The parser used in the default class
         */
         ...
         *      It creates a new routePoint when a <rtept> markup is encountered.
         *      It saves informations about <link> in currentPoint or currentLine.
         * @param uri
         *      URI of the local element
         * @param localName
         *      Name of the local element (without prefix)
         * @param qName
         *      qName of the local element (with prefix)
         * @param attributes
         *      Attributes of the local element (contained in the markup)
         * @throws SAXException
         ...
         *      It catches attributes of routePoints or routes and saves them in corresponding values[].
         * @param uri
         *      URI of the local element
         * @param localName
         *      Name of the local element (without prefix)
