...
public class TSVDriverTest {
    ...
    public static void tearUp() throws Exception {
        ...
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new TSVRead(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new TSVWrite(), "");
