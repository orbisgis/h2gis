...
public class KMLImporterExporterTest {
    ...
    public static void tearUp() throws Exception {
        ...
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new KMLWrite(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new ST_AsKml(), "");
    }
