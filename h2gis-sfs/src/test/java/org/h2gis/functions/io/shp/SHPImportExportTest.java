...
public class SHPImportExportTest {
    ...
    public static void tearUp() throws Exception {
        ...
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new SHPRead(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new SHPWrite(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new DBFWrite(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new DBFRead(), "");
    }
