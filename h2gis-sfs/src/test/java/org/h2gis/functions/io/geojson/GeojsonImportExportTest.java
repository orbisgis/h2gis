...
public class GeojsonImportExportTest {
    ...
    public static void tearUp() throws Exception {
        ...
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new ST_AsGeoJSON(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new GeoJsonWrite(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new GeoJsonRead(), "");
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new ST_GeomFromGeoJSON(), "");
