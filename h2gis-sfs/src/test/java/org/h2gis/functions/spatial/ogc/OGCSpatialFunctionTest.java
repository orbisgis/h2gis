...
public class OGCSpatialFunctionTest {
    ...
    public void testFunctionRemarks() throws SQLException {
        H2GISFunctionsFactory.registerFunction(connection.createStatement(), new DummyFunction(), "");
        ...
        procedures.close();
        H2GISFunctionsFactory.unRegisterFunction(connection.createStatement(), new DummyFunction());
    }
