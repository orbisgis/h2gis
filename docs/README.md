...
H2GIS requires Java 11 and [GraalVM 22.3.3](https://github.com/graalvm/graalvm-ce-builds/releases/tag/vm-22.3.3). Run `maven clean install -P standalone` in the H2GIS's root directory.
