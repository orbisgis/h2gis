...
permalink: /docs/dev/ST_GoogleMapLink/
---
...
{% highlight mysql %}
SELECT ST_GoogleMapLink(ST_TRANSFORM(ST_SETSRID(GEOM, 2154), 4326)) as URL FROM NANTES_CASTLE;
...
{% highlight mysql %}
SELECT ST_GoogleMapLink(ST_TRANSFORM(ST_SETSRID(GEOM, 2154), 4326), 'k') as URL FROM NANTES_CASTLE;
...
{% highlight mysql %}
SELECT ST_GoogleMapLink(ST_TRANSFORM(ST_SETSRID(GEOM, 2154), 4326), 'm', 10) as URL FROM NANTES_CASTLE;
...
{% highlight mysql %}
SELECT ST_GoogleMapLink(ST_TRANSFORM(ST_SETSRID(GEOM, 2154), 4326), 'm', 19) as URL FROM NANTES_CASTLE;
